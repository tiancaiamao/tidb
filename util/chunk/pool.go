...
func NewPool(initCap int) *Pool {
	return &Pool{
		initCap:         initCap,
		varLenColPool:   &sync.Pool{New: func() interface{} { return newVarLenColumn(defaultArenaAlloc{}, initCap) }},
		fixLenColPool4:  &sync.Pool{New: func() interface{} { return newFixedLenColumn(defaultArenaAlloc{}, 4, initCap) }},
		fixLenColPool8:  &sync.Pool{New: func() interface{} { return newFixedLenColumn(defaultArenaAlloc{}, 8, initCap) }},
		fixLenColPool16: &sync.Pool{New: func() interface{} { return newFixedLenColumn(defaultArenaAlloc{}, 16, initCap) }},
		fixLenColPool40: &sync.Pool{New: func() interface{} { return newFixedLenColumn(defaultArenaAlloc{}, 40, initCap) }},
	}
}
