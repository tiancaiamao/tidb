...
func buildTableInfoWithLike(ctx sessionctx.Context, ident ast.Ident, referTblInfo *model.TableInfo, s *ast.CreateTableStmt) (*model.TableInfo, error) {
	...
	tblInfo.CachedTableStatusType = model.CachedTableDISABLE
...
func (d *ddl) AlterTable(ctx context.Context, sctx sessionctx.Context, ident ast.Ident, specs []*ast.AlterTableSpec) (err error) {
	...
	for _, spec := range validSpecs {
		...
		case ast.AlterTableEnableCached:
			err = d.EnableCachedTable(sctx, ident)
		case ast.AlterTableDisableCached:
			err = d.DisableCachedTable(sctx, ident)
...
func (d *ddl) EnableCachedTable(ctx sessionctx.Context, ti ast.Ident) error {
	schema, t, err := d.getSchemaAndTableByIdent(ctx, ti)
	if err != nil {
		return err
	}
	job := &model.Job{
		...
		TableID:    t.Meta().ID,
		SchemaName: schema.Name.L,
		Type:       model.ActionEnableCachedTable,
		BinlogInfo: &model.HistoryInfo{},
		Args:       []interface{}{},
	}
...
func (d *ddl) DisableCachedTable(ctx sessionctx.Context, ti ast.Ident) error {
	schema, t, err := d.getSchemaAndTableByIdent(ctx, ti)
	if err != nil {
		return err
	}
	job := &model.Job{
		...
		TableID:    t.Meta().ID,
		SchemaName: schema.Name.L,
		Type:       model.ActionDisableCachedTable,
		BinlogInfo: &model.HistoryInfo{},
		Args:       []interface{}{},
	}
