...
const (
	...
	ActionEnableCachedTable             ActionType = 54
	ActionDisableCachedTable            ActionType = 55
)
...
var actionMap = map[ActionType]string{
	...
	ActionEnableCachedTable:             "enable cached table",
	ActionDisableCachedTable:            "disable cached table",
}
